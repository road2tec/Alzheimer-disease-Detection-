                    ...
                    >
                        ...
                        <div>
                            <div className="flex justify-between items-start mb-6">
                                <span className="px-4 py-1.5 bg-medical-50 text-medical-600 rounded-full text-[10px] font-black uppercase tracking-widest border border-medical-100">
                                    {plan.name}
                                </span>
                        ...
                        <button className="w-full py-3.5 bg-slate-900 text-white rounded-2xl font-black text-[10px] uppercase tracking-[0.2em] hover:bg-medical-600 transition-all shadow-lg active:scale-95 flex items-center justify-center gap-2 group">
